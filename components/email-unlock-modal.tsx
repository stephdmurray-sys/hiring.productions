  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Drop your email and I&apos;ll unlock <span style={{ color: '#F2F0FF', fontWeight: 800 }}>10 more runs</span> across every free tool. No card. No password. The 6-second resume-read guide goes to your inbox right after.
        </p>
        ...
        <form onSubmit={submit}>
          ...
          >
            {submitting ? 'Unlocking…' : 'Unlock 10 more runs →'}
          </button>
        </form>
