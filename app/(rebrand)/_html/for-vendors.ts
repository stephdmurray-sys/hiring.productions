...
<div class="navbar">
  ...
  <div class="wrap" style="max-width:760px;padding:52px 24px 72px;">
    <h1 style="font-family:'Poppins',sans-serif;font-weight:700;font-size:32px;margin-bottom:18px;">For vendors</h1>
    <p style="color:#4B5563;margin-bottom:14px;">We review hiring software for companies and job seekers. If you build hiring tech, you can be part of that coverage. Listing is free and always will be.</p>
    <p style="color:#4B5563;margin-bottom:14px;"><b>Submit your product:</b> pricing, features, ideal customer, and product materials. A written submittal upgrades your review to the Vendor Submitted evidence level.</p>
    <p style="color:#4B5563;margin-bottom:14px;"><b>Book a demo walkthrough:</b> show us the live product and answer our structured questionnaire. That earns the Vendor Demoed level, our strongest.</p>
    <p style="color:#4B5563;margin-bottom:14px;"><b>Startups:</b> early stage products go on our radar before they enter the rankings. Submitting early gets you watched, not judged.</p>
    <p style="color:#4B5563;margin-bottom:20px;">What none of this buys: a score, a ranking, or a recommendation. Read <a href="/how-we-review" style="color:#6D28D9;font-weight:700;">how we review</a> before you reach out.</p>
    <a href="mailto:hello@hiring.productions?subject=Product%20submittal" style="display:inline-block;background:#6D28D9;color:#fff;font-family:'Poppins',sans-serif;font-weight:600;font-size:12.5px;letter-spacing:0.08em;text-transform:uppercase;padding:13px 26px;border-radius:999px;">Submit your product</a>
  </div>
  <footer>
    <div class="wrap">
      <div class="fcols">
