export const headerHtml = `<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .rec-hero{background:linear-gradient(160deg,var(--hero) 55%,var(--hero-2));color:#fff;padding:46px 0 50px;}
  .rec-hero h1{font-family:'Poppins',sans-serif;font-weight:700;font-size:clamp(30px,3.8vw,44px);margin-bottom:12px;}
  .rec-sub{font-size:14.5px;color:#C9BFE8;max-width:640px;line-height:1.7;}
  .rec-layout{display:grid;grid-template-columns:1.1fr 0.9fr;gap:40px;padding:52px 0 72px;align-items:start;}
  .rec-form{background:#fff;border:1px solid var(--border);border-radius:16px;padding:28px;box-shadow:0 2px 12px rgba(20,20,32,0.06);}
  .rec-form label{display:block;font-family:'Poppins',sans-serif;font-weight:600;font-size:12.5px;margin:16px 0 6px;}
  .rec-form label:first-of-type{margin-top:0;}
  .rec-form input,.rec-form select,.rec-form textarea{width:100%;border:1px solid var(--border);border-radius:9px;padding:11px 13px;font-family:'Open Sans',sans-serif;font-size:13.5px;color:var(--ink);background:#fff;box-sizing:border-box;}
  .rec-form textarea{min-height:90px;resize:vertical;}
  .rec-form input:focus,.rec-form select:focus,.rec-form textarea:focus{outline:2px solid var(--purple);outline-offset:1px;border-color:var(--purple);}
  .rec-submit{width:100%;margin-top:22px;background:var(--purple);color:#fff;border:none;cursor:pointer;font-family:'Poppins',sans-serif;font-weight:600;font-size:13px;letter-spacing:0.08em;text-transform:uppercase;border-radius:999px;padding:14px;}
  .rec-submit:hover{background:var(--purple-dark);}
  .rec-submit:disabled{opacity:0.6;cursor:default;}
  .rec-error{color:#C1113A;font-size:12.5px;margin-top:10px;}
  .rec-done{background:#E7F8F0;border:1px solid #0E9F5D33;color:#0A5C38;border-radius:12px;padding:18px;font-size:14px;line-height:1.6;}
  .rec-side h2{font-family:'Poppins',sans-serif;font-weight:700;font-size:clamp(20px,2.4vw,26px);margin-bottom:14px;}
  .rec-point{display:flex;gap:12px;margin-bottom:16px;font-size:13.5px;color:var(--gray);line-height:1.6;}
  .rec-point b{color:var(--ink);}
  .rec-n{font-family:'Poppins',sans-serif;font-weight:800;color:var(--purple);font-size:15px;flex-shrink:0;}
...
<div class="navbar">
  ...
  <div class="rec-hero">
    <div class="wrap">
      <p style="font-size:12.5px;color:#8B7FBF;margin-bottom:14px;"><a href="/" style="color:#B3A8DE;">Home</a> &rsaquo; Get a recommendation</p>
      <h1>Get a stack recommendation. Free.</h1>
      <p class="rec-sub">Tell us how you hire. You get back the exact tools we would run for your team, built with the same scoring you see on the guides. No charge, no sales call, and no vendor can pay their way into the answer.</p>
    </div>
  </div>`
