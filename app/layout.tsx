...
export const metadata: Metadata = {
  ...
  description: 'The only place where candidates see how they\'re evaluated and hiring teams see how they\'re experienced. 20 inside looks. Both sides. Free to start.',
